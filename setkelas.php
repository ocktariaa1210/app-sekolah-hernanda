<?php
    ...
    $setkelas = mysqli_query($conn, "select a.nama_siswa, b.nama_kelas, c.tahun from tbsiswa a, tbkelas b, tbsetkelas
     c where a.id=c.idsiswa AND b.idkelas=c.idkelas order by b.nama_kelas, a.nama_siswa asc");
?>

<div style="width: 48%;min-height:300px;float:left; padding-left:5px;">
<h3 style="color:red;"> Siswa Belum Punya Kelas</h3>
<form action ="?hal=proses_setkelas" method="post">
    <table>
        <?php
